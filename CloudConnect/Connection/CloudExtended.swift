...
public protocol CloudExtended {
    ...
    static var hcsCloud: CloudExtendedExtension<ExtendedType>.Type { get set }
    /// Instance CloudService extension point.
    var hcsCloud: CloudExtendedExtension<ExtendedType> { get set }
}

public extension CloudExtended {
    /// Static CloudService extension point.
    static var hcsCloud: CloudExtendedExtension<Self>.Type {
        get { CloudExtendedExtension<Self>.self }
        set {}
    }

    /// Instance CloudService extension point.
    var hcsCloud: CloudExtendedExtension<Self> {
